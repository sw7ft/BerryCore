...
extern void *__memcpy_isr(void *__s1, const void *__s2, _CSTD size_t __n);
extern void *__memset_isr(void *__s, int __c, _CSTD size_t __n);
extern _Const_return void *__memchr_isr(const void *__s, int __c, _CSTD size_t __n);
extern char *__strcpy_isr(char *__s1, const char *__s2);
extern _Const_return char *__strchr_isr(const char *__s, int __c);
extern _CSTD size_t __strlen_isr(const char *__s);
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_3_1/lib/c/public/string.h $ $REV$")
#endif
