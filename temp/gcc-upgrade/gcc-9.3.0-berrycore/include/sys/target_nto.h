...
// longer _INT_C2 avoids conflict with libstdc++
		/* integer properties */
#define _BITS_BYTE	8
#define _INT_C2			1	/* 0 if not 2's complement */
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_3_1/lib/c/public/sys/target_nto.h $ $REV$")
#endif
