 ...
 */
#if 1
#if defined(_REENTRANT) || defined(__MT__) || defined(__QNXNTO__) || \
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_3_1/lib/xml2/public/libxml/xmlversion.h $ $Rev: 761454 $")
#endif
