...
enum opt_code
{
  ...
  OPT_mabi_ = 1277,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1278,             /* -mabort-on-noreturn */
  OPT_mapcs = 1279,                          /* -mapcs */
  OPT_mapcs_frame = 1280,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1281,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1282,              /* -mapcs-stack-check */
  OPT_march_ = 1283,                         /* -march= */
  OPT_marm = 1284,                           /* -marm */
  OPT_masm_syntax_unified = 1285,            /* -masm-syntax-unified */
  OPT_mbe32 = 1286,                          /* -mbe32 */
  OPT_mbe8 = 1287,                           /* -mbe8 */
  OPT_mbig_endian = 1288,                    /* -mbig-endian */
  ...
  OPT_mneon_for_64bits = 1303,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1304,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1305,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1306,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1307,               /* -mprint-tune-info */
  OPT_mpure_code = 1308,                     /* -mpure-code */
  OPT_mrestrict_it = 1309,                   /* -mrestrict-it */
  OPT_msched_prolog = 1310,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1311,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1312,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1313, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1314,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1315,                         /* -mthumb */
  OPT_mthumb_interwork = 1316,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1317,                  /* -mtls-dialect= */
  OPT_mtp_ = 1318,                           /* -mtp= */
  OPT_mtpcs_frame = 1319,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1320,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1321,                         /* -mtune= */
  OPT_munaligned_access = 1322,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1323,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1324,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1325,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1326,              /* -mword-relocations */
  OPT_n = 1327,                              /* -n */
  OPT_no_canonical_prefixes = 1328,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1329,              /* -no-integrated-cpp */
  OPT_no_pie = 1330,                         /* -no-pie */
  OPT_nocpp = 1331,                          /* -nocpp */
  OPT_nodefaultlibs = 1332,                  /* -nodefaultlibs */
  OPT_nolibc = 1333,                         /* -nolibc */
  OPT_nophoboslib = 1334,                    /* -nophoboslib */
  /* OPT_nopie = 1335, */                    /* -nopie */
  ...
  OPT_pie = 1346,                            /* -pie */
  OPT_pipe = 1347,                           /* -pipe */
  OPT_posix = 1348,                          /* -posix */
  OPT_print_file_name_ = 1349,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1350,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1351,          /* -print-multi-directory */
  OPT_print_multi_lib = 1352,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1353,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1354,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1355,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1356,               /* -print-prog-name= */
  OPT_print_search_dirs = 1357,              /* -print-search-dirs */
  OPT_print_sysroot = 1358,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1359,   /* -print-sysroot-headers-suffix */
  OPT_pthread = 1360,                        /* -pthread */
  OPT_quiet = 1361,                          /* -quiet */
  OPT_r = 1362,                              /* -r */
  OPT_rdynamic = 1363,                       /* -rdynamic */
  OPT_remap = 1364,                          /* -remap */
  OPT_rpath_link = 1365,                     /* -rpath-link */
  OPT_rpath_link_ = 1366,                    /* -rpath-link= */
  OPT_rpath_ = 1367,                         /* -rpath= */
  OPT_s = 1368,                              /* -s */
