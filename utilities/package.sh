...
if [ $? -eq 0 ]; then
    ...
    for file in env.sh pbpkgadd sample_profile CATALOG qconf-override.mk doc/berrycore.html share/term49-splash.sh share/term48rc bin/games share/games/index.html packages/games-bb-games-1.0.zip; do
