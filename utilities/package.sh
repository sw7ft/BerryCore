...
if [ $? -eq 0 ]; then
    ...
    for file in env.sh pbpkgadd sample_profile CATALOG qconf-override.mk doc/berrycore.html share/term49-splash.sh share/term48rc bin/setup share/setup/index.html share/setup/settings.html bin/talkbutton bin/games share/games/index.html packages/games-bb-games-1.0.zip bin/sttlab bin/sttlabs share/sttlab/index.html share/sttlab/term.html share/sttlab/term49.py share/sttlab/serve.py share/sttlab/STT-Drop.apk bin/vosk packages/web-sttlab-1.1.zip bin/library bin/books share/books/index.html share/books/serve.py share/books/classics/cacm.html bin/stocks bin/ticker share/stocks/index.html share/stocks/serve.py packages/web-stocks-1.0.zip bin/waterwaymap bin/waterway share/waterwaymap/index.html share/waterwaymap/serve.py packages/web-waterwaymap-1.0.zip bin/sensors bin/sensor bin/gps share/sensors/HELP.txt share/gps/HELP.txt packages/util-sensors-1.1.zip packages/util-gps-1.0.zip; do
