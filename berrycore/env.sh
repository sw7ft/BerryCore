...
echo ""
echo "==========================================================="
echo "     BerryCore v0.90.1 - QNX Extended Userland"
echo "==========================================================="
echo ""
...
echo "  qpkg remove NAME    Uninstall a port (or: qpkg uninstall)"
echo ""
echo "Quick navigation shortcuts:"
echo "  misc, docs, downloads, sdcard, bc"
echo ""
echo "Quick start: setup, sensors, gps, assistant, rocketchat4, talkbutton, nano, vim, git, nmap, curl, linux, games, library, waterwaymap, stocks, solarsystem, sttlab, term49-web"
echo ""
