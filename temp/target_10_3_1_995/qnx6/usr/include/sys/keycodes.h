...
#define KEYCODE_AC_REPLY_ALL                                    (KEYCODE_CONSUMER_KEYS + 0x48)
...
__SRCVERSION("$URL: http://svn.ott.qnx.com/product/branches/deckard/BB10_3_1/lib/ph/public/sys/keycodes.h $ $REV$")
#endif
