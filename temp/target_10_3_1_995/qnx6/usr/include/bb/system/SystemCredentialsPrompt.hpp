 ...
 *
 * @image html system_credentials_prompt.png A system credentials prompt
 *
 * @details The displayed prompt is an application-modal window.
 *
...
class BB_SYSTEM_EXPORT SystemCredentialsPrompt : public QObject
{
    ...
    /*!
     * @brief Indicates whether a check box for displaying the password in cleartext should be included.
    ...
    /*!
     * @brief Indicates whether a check box for remembering password credentials should be included.
    ...
    /*!
     * @brief Represents the selection state of the check box for remembering password credentials.
    ...
    /*!
     * @brief Represents the text associated with the check box associated with @c rememberMeChecked.
     ...
     * @note -1 implies that the default system behavior will be applied. The supported range is 1-3. Any values outside the range reset the property to its default value.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Represents the username field that is included in the window.
    ...
    /*!
     * @brief Represents the password field that is included in the window.
...
public:
    ...
    /*!
     * @brief Destroys the credentials prompt, and cancels any pending requests.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Retrieves the flag indicating if a check box that can reveal the password field should be included in the prompt.
    ...
    /*!
     * @brief Retrieves the flag indicating if a check box to remember the credentials should be included in the prompt.
    ...
    /*!
     * @brief Retrieves the prompt's cancellation button.
     * @details This instance retains ownership of the returned value.
     ...
     * @details This can be combined with setting @c dismissAutomatically to false
     * to update the prompt while it is being displayed.
    ...
    /*!
     * @brief Sets the preference for displaying a password check box.
     * @param value The preference for including the password check box in the prompt.
     *
     * @since BlackBerry 10.0.0
     */
    ...
    /*!
     * @brief Sets the flag indicating if a check box for remembering the credentials should be included in the prompt.
     * @param value @c true if a check box for remembering the credentials should be included, @c false otherwise.
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * @details All properties of the username input field are reset.
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * @details All properties of the password input field are reset.
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * @details The label of the button is reset to its default value of @c "Login".
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * @details The label of the cancellation button is reset to its default value of @c "Cancel".
     *
     * @since BlackBerry 10.0.0
     */
     ...
     * was selected.
     * @details If the confirmation button was not selected or the toggle was not displayed in the prompt, @c false is returned.
     *
     * The return value is reset when a new request is made.
     *
...
public Q_SLOTS:
     ...
     * @details The result of the request can be retrieved with the @c SystemCredentialsPrompt::result property, or by using the @c finished() signal.
...
Q_SIGNALS:
     ...
     * @details When the user dismisses the prompt, the user selection is available using @c rememberMeSelection().
